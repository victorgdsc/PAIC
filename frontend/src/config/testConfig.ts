export interface ExampleFile {
  ...
  path: string;
  description: string;
  numericColumns?: readonly string[];    columnMapping?: {                        readonly [columnName: string]: "estimatedDate" | "actualDate" | "factor" | "delay";
  };
}
  ...
  EXAMPLE_FILES: [
    {
      ...
      path: '/SCMS_Delivery_History_Dataset.csv',
...
'O arquivo possui 120.105 registros, o que melhora a confiabilidade das previsões. Por ser grande, pode demorar mais para carregar e deixar a navegação mais lenta.'],
      ...
      },
      {
        ...
        path: '/DataCoSupplyChainDataset_final.csv',
